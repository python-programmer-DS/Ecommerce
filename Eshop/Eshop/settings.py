...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # Keep this line only once
    'store',  # Your app
]
...
ROOT_URLCONF = 'Eshop.urls'  # Replace with your project name
...
WSGI_APPLICATION = 'Eshop.wsgi.application'  # Replace with your project name
